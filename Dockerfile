...
RUN echo "alias pip=pip3" >> ~/.bash_aliases && echo "alias python=python3" >> ~/.bash_aliases && pip3 install -q GDAL==1.11.3 --global-option=build_ext --global-option="-I/usr/include/gdal"
